...
require "cloudflare/dns_records"
...
module Cloudflare
  ...
  class Client
    attr_reader :zones, :dns_records, :filters, :firewall_rules
    ...
    def initialize(api_token: nil, auth_email: nil, auth_key: nil, base_url: 'https://api.cloudflare.com/client/v4')
      ...
      @dns_records = Cloudflare::DnsRecords.new(base_url: "#{base_url}/zones", **auth_params)
